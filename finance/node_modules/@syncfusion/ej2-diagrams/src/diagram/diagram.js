                        ...
                        if (sourceElement) {
                            ...
                            if (sourceElement[selectedSymbols] instanceof Node) {
                                if (obj.shape.shape === 'TextAnnotation') {
                                    clonedObject.offsetX = position.x + 11 + (clonedObject.width || wrapper.actualSize.width) * clonedObject.pivot.x;
                                    clonedObject.offsetY = position.y + 11 + (clonedObject.height || wrapper.actualSize.height) * clonedObject.pivot.y;
                                }
                                else {
                                    clonedObject.offsetX = position.x + 5 + (clonedObject.width || wrapper.actualSize.width) * clonedObject.pivot.x;
                                    clonedObject.offsetY = position.y + (clonedObject.height || wrapper.actualSize.height) * clonedObject.pivot.y;
                                }
