...
import { ParagraphWidget, LineWidget, ElementBox, TextElementBox, Margin, ImageElementBox, BlockWidget, BlockContainer, BodyWidget, TableWidget, TableCellWidget, TableRowWidget, Widget, ListTextElementBox, BookmarkElementBox, HeaderFooterWidget, FieldTextElementBox, TabElementBox, EditRangeStartElementBox, EditRangeEndElementBox, CommentElementBox, CommentCharacterElementBox, CheckBoxFormField, DropDownFormField, TextFormField, ShapeElementBox, TextFrame, ContentControl } from '../viewer/page';
                        ...
                        if (isNullOrUndefined(elementIndex)) {
                            ...
                            if (indexInInline === 0) {
                                ...
                                for (var i = elementBox.revisions.length - 1; i >= 0; i--) {
                                    ...
                                    var index_1 = revision_1.range.indexOf(elementBox);
                                    ...
                                    revision_1.range.splice(index_1 + 1, 0, newElement);
                                    text.revisions.splice(0, 0, revision_1);
                                    text.line = elementBox.line;
                                    revision_1.range.splice(index_1 + 1, 0, text);
