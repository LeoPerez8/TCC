...
var Layout = /** @class */ (function () {
    ...
    Layout.prototype.updateTopBorders = function (cell) {
        ...
        if (cell.ownerTable.tableFormat.cellSpacing === 0) {
            ...
            var adjCells = this.getAdjacentRowCell(cell, cell.x, cell.x + cell.width, cell.rowIndex - 1);
